    ...
    if(isBuy === 0){
        return(
            <div className = "sellContainer">
                <p className = "sharePrompt">Enter Shares to Sell: <input className = "toSellInput"></input></p>
                <p className = "totalEst">Estimated Total: <p className = "estValue">$###.###</p></p>
                <div className = "confirmContain"><Checkbox/><p className= "confirmText">Confirm</p></div>
        ...
        return(
            <div className = "sellContainer">
                <p className = "sharePrompt">Enter Shares to Buy: <input className = "toSellInput"></input></p>
                <p className = "totalEst">Estimated Total: <p className = "estValue">$###.###</p></p>
                <div className = "confirmContain"><Checkbox/><p className= "confirmText">Confirm</p></div>
