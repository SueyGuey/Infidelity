	...
	return user ? (
		<div className = "buySellPopUp">
            ...
            <div className = "sellContainer">
                <p className = "portNamePrompt">Name of Portfolio: <input className = "toSellInput"></input></p>
				<p className = "balanceStartPrompt">Enter Initial Balance: <input className = "toSellInput"></input></p>
