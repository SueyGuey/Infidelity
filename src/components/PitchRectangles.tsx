        ...
        <div className = 'parent'>
            ...
            <span className='pitches pitchRectangleOne'>
                ...
                <div className = 'rectangleText'>
                    ...
                    <p className = 'rectangleTextParagraph'>Infidelity doesn’t do trades with real money. All money in your account or in your stocks, shares, options, crypto-- are traded in our currency. No need to worry about your personal finances if a trade isn’t going your way.</p>
                </div>
            </span>
            ...
            <span className='pitches pitchRectangleTwo'>
                ...
                <div className = 'rectangleText'>
                    ...
                    <p className = 'rectangleTextParagraph'>The values you see are in near-real-time, and are constantly updated. No awkward jumps, and no severely outdated data. This is essential to the authentic trading experience. </p>
                </div>
            </span>
